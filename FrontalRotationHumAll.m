...
for k = 2: numFiles
    ...
    % Asign Pre Post
    rotationPre = target.PreHumFro; % target movement
    rotationPost = target.PostHumFro; % target movement
...
title('ROM Humerus (Frontal Rotation) - 50°')
...
plot(romPost100,'-ro')
legend({'Pre','Post'},'Location','southwest')
title('ROM Humerus (Frontal Rotation) - 100°')
