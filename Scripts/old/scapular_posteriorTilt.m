...
for k = 2: numFiles
    ...
    % Asign Pre Post
    rotationPre = target.Escapular_Pre_ScapularTilt; % target movement
    rotationPost = target.Escapular_Post_ScapularTilt; % target movement
    ...
    for b = 1: 5
        ...
        %Calculate (and store) ROM for each subject
