...
%Calculate ROM
romPre50 = [romPre50,mean(endPre50-startPre50)];
romPre100 = [romPre100, mean(endPre100-startPre100)];
romPost50 = [romPost50,mean(endPost50-startPost50)];
romPost100 = [romPost100,mean(endPost100-startPost100)];
